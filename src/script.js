...
const brickRougnessTexture = textureLoader.load('/textures/bricks/roughness.jpg')
...
const walls = new THREE.Mesh(
    ...
    new THREE.MeshStandardMaterial({ 
        ...
        roughnessMap: brickRougnessTexture
...
const roof = new THREE.Mesh(
    ...
    new THREE.MeshStandardMaterial({ color: '#400000' })
)
...
const material = new THREE.MeshBasicMaterial({ color: '#a06315', wireframe: true ,  roughness: 0.5,
metalness: 0.5,
castShadow: true,
receiveShadow: true,})
...
const basePositions = [
    { x: 1.3, y: 0.20, z: 2.3 },
    { x: 1.35, y: 0.60, z: 2.15 },
    { x: -1.3, y: 0.20, z: 2.30 },
    { x: -1.40, y: 0.60, z: 2.35}
];

const rectangles = [];

// Kreiranje i postavljanje 4 pravougaonika
for (let i = 0; i < basePositions.length; i++) {
    ...
    mesh.scale.set(0.25, 0.10, 0.10) // Postavljanje skaliranja

    scene.add(mesh)
    rectangles.push(mesh)
}

// Ovde sada možete pristupiti pojedinačnim pravougaonicima preko niza rectangles
const rectangle1 = rectangles[0]
const rectangle2 = rectangles[1]
const rectangle3 = rectangles[2]
const rectangle4 = rectangles[3]
